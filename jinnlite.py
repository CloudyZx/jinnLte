# ----------------------------------------------------------------------------------------------
# Jinn Lite - Smokeless iDDOS Tool
#
# The Jinn Lite is Lite version of Jinn it's one of the Most Powerful iDDOS Tool
# This tool can Shut down any websites
# 
#
# author : Price V , version 1.0 Lite
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'Jinn Lite Smokeless DDoS Tool'
	...
	print 'Army anons Instagram: http://wwww.instagram.com/price.v_'
	print 'New loaded Botnets: 1,798,498'
	print 'Usage: Jinn Lite (url)'
	print 'Example: JinnLite.py http://israbank.gov.il/'
	print "\a"
print \
"""
 ooooo o88                           
   ...
   888   888   888   888   888   888  
   888  o888o o888o o888o o888o o888o Lite
8o888        
